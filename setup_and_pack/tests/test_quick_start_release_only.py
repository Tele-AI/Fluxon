...
class QuickStartReleaseOnlyTest(unittest.TestCase):
    ...
    def test_stage_build_context_copies_release_wheels_without_source_tree(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (release_dir / "fluxon_py-0.2.1-cp38-abi3-manylinux_2_28_x86_64.whl").write_text("wheel", encoding="utf-8")
            ...
            self.assertTrue(
                (context_root / "fluxon_release" / "fluxon_py-0.2.1-cp38-abi3-manylinux_2_28_x86_64.whl").is_file()
            )
