...
def _load_test_bed_deployconf_path() -> Path:
    return test_bed_transport.load_test_bed_deployconf_path(
        bootstrap_config_path=_load_test_bed_bootstrap_config_path(),
    )


def _load_test_bed_manifest_opt() -> Optional[Tuple[Path, Dict[str, Any]]]:
    return test_bed_transport.load_test_bed_manifest_opt(
        bootstrap_config_path=_load_test_bed_bootstrap_config_path(),
    )
...
def _canonical_targets_for_ip_from_test_bed(node_ip: str) -> List[str]:
    return test_bed_transport.canonical_targets_for_ip_from_test_bed(
        bootstrap_config_path=_load_test_bed_bootstrap_config_path(),
        node_ip=node_ip,
    )
...
def _test_bed_manifest_transport_ctx_opt() -> Optional[Dict[str, Any]]:
    return test_bed_transport.load_test_bed_manifest_transport_ctx_opt(
        bootstrap_config_path=_load_test_bed_bootstrap_config_path(),
    )
...
def _controller_request_via_manifest(
    ...
    *,
    ...
    return test_bed_transport.controller_request_via_manifest(
        req,
